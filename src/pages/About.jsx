...
const aboutStyle = {
  ...
  overflow: " hidden",
  background:
    "url(./stars.png),-webkit-gradient(linear, left top, right bottom, from(#00020b), to(#02093c))",
        ...
        <div>
          ...
          <div className="about-global">
            <section className="about-section-two">
              <div className="about-global-svg">
                <svg
              ...
              <div className="about-global-text">
                ...
                <i className="d-elo">Jb_Basic</i> is the go-to resource for discovering and
                connecting with designers and creative talent around the globe.
                Dribbble helps some of the world’s best design-forward companies
                including <span>Apple</span>,
                <span className="airbnb">Airbnb</span>,{" "}
                <span className="ideo">IDEO</span>,
                <span className="face-book">Facebook</span>, 
                <span>
                  <span className="google-G">G</span>
                  <span className="google-o">o</span>
                  <span className="google-otwo">o</span>
                  <span className="google-g">g</span>
                  <span className="google-l">l</span>
                  <span className="google-e">e</span>
                
                  </span>
                , <span className="drop-box">Dropbox</span>,
                <span className="slack">Slack</span>,{" "}
                <span className="shopify">Shopify,</span>{" "}
                <span className="lyfa">Lyft</span> get exposure for their design
                teams and to help them hire expert creatives.
              </div>
            </section>
          </div>
        </div>
